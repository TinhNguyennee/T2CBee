		...
		<div class="col-md-3">
			<div class="product-list-title text-center">
				...
				<div class="list-group rounded-0">
					<a href="#" class="list-group-item lst list-group-item-action item-active" aria-current="true"> The
						current link item </a> <a href="#" class="list-group-item lst list-group-item-action">A second
						link item</a> <a href="#" class="list-group-item lst list-group-item-action">A third
						link item</a> <a href="#" class="list-group-item lst list-group-item-action">A fourth
						link item</a> <a href="#" class="list-group-item lst list-group-item-action">A fourth
						link item</a> <a href="#" class="list-group-item lst list-group-item-action">A fourth
						link item</a>
				</div>
