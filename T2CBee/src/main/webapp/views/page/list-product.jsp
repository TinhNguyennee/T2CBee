						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								...
								<li><a class="dropdown-item" href="/danh-sach-san-pham/${danhMuc}?sort=priceAsc">Giá
										tăng dần</a></li>
								<li><a class="dropdown-item" href="/danh-sach-san-pham/${danhMuc}?sort=priceDesc">Giá
										giảm dần</a></li>
									...
									<form action="/danh-sach-san-pham/${danhMuc}" method="post">
										...
										<div class="form_control">
											<div class="form_control_container">
												...
												<input class="form_control_container__time__input w-100" type="number"
													name="min" value="${minPrice}" id="fromInput" min="1000000"
													max="10000000" />
											</div>
											<div class="form_control_container">
												<div class="form_control_container__time">Cao nhất</div>
												<input class="form_control_container__time__input w-100" type="number"
													name="max" value="${maxPrice}" id="toInput" min="1000000"
													max="10000000" />
											</div>
										</div>
									</form>
									...
									<ul
										...
										<c:if test="${page.totalPages > 1}">
											<c:forEach var="i" begin="0" end="${page.totalPages - 1}">
												<li class="page-item ${page.number == i ? 'pagination-active' : ''}">
