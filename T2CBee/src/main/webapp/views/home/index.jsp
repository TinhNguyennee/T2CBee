...
<div class="container-fluid position-relative p-0">
		...
		<div class="container">
			<div
				class="home-title position-absolute top-50 translate-middle-y z-1">
				<h4>NEW ARRIVALS</h4>
		...
		<div id="carouselExampleIndicators" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="../images/home-slider1.jpg" class="d-block w-100"
						alt="...">
				</div>
				<div class="carousel-item">
					<img src="../images/home-slider2.jpg" class="d-block w-100"
						alt="...">
				</div>
				<div class="carousel-item">
					<img src="../images/home-slider3.jpg" class="d-block w-100"
						alt="...">
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card card-product position-relative">
						...
						<div
							class="card-title card-product-title position-absolute pt-5 ps-5">
							<h5>Cyber Monday</h5>
				...
				<div class="product-list-title text-center">
					...
					<div class="list-group rounded-0">
						<a href="#"
							...
							class="list-group-item lst list-group-item-action">A second
							link item</a> <a href="#"
							class="list-group-item lst list-group-item-action">A third
							link item</a> <a href="#"
							class="list-group-item lst list-group-item-action">A fourth
							link item</a> <a href="#"
							class="list-group-item lst list-group-item-action">A fourth
							link item</a> <a href="#"
							class="list-group-item lst list-group-item-action">A fourth
				...
				<div class="col-md-3">
					<div class="card rounded-0">
						...
						<div class="card-body">
							...
							<p class="card-title mb-2 fw-bold">Mirum est notare tellus eu
								nibh iaculis pretium</p>
				...
				<div class="col-md-3">
					<div class="card rounded-0">
						...
						<div class="card-body">
							...
							<p class="card-title mb-2 fw-bold">Eodem modo vel mattis ante
								facilisis nec porttitor efficitur</p>
							<h5 class="fw-bold product-price">$86.00</h5>
						</div>
					</div>
				</div>
					...
					<div class="card rounded-0">
						...
						<div class="card-body">
							<div class="title-head d-flex m-0">
								...
								<div class="rating w-100 text-end text-warning">
									<i class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i>
									<i class="bi bi-star-fill"></i> <i class="bi bi-star"></i> <i
										class="bi bi-star"></i>
								</div>
							</div>
							<p class="card-title mb-2 fw-bold">Laudantium enim fringilla
								dignissim ipsum primis</p>
							<h5 class="fw-bold product-price">$86.00</h5>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="card rounded-0">
						...
						<div class="card-body">
							...
							<p class="card-title mb-2 fw-bold">Pellentesque ultricies
								suscipit est in sapien hendrerit</p>
				...
				<div class="col-md-4">
					<div class="card rounded-0">
						...
						<div class="card-body card-product-body">
							<p class="card-title mb-2 fw-bold fs-5">Laudantium enim
								fringilla dignissim ipsum primis</p>
